...
less_sixty_sbl_femur = pd.concat( [less_sixty_femur.loc[:, 'F0_femur':'F199_femur'], less_sixty_femur[
    ["time", "right_tkr"]]], axis = 1)

less_sixty_sbl_tibia = pd.concat( [less_sixty_tibia.loc[:, 'T0_tibia':'T199_tibia'], less_sixty_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
sixty_seventy_sbl_femur = pd.concat( [sixty_seventy_femur.loc[:, 'F0_femur':'F199_femur'], sixty_seventy_femur[
    ["time", "right_tkr"]]], axis = 1)

sixty_seventy_sbl_tibia = pd.concat( [sixty_seventy_tibia.loc[:, 'T0_tibia':'T199_tibia'], sixty_seventy_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
greater_seventy_sbl_femur = pd.concat( [greater_seventy_femur.loc[:, 'F0_femur':'F199_femur'], greater_seventy_femur[
    ["time", "right_tkr"]]], axis = 1)

greater_seventy_sbl_tibia = pd.concat( [greater_seventy_tibia.loc[:, 'T0_tibia':'T199_tibia'], greater_seventy_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_less_60_SBL_Normalized_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_less_60_SBL_Normalized_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_less_60_SBL_Normalized_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_1.to_csv('/home/tsurendr/TABLES/AGE_less_60_SBL_Normalized.csv', index=False)
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_60_70_SBL_Normalized_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_60_70_SBL_Normalized_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_60_70_SBL_Normalized_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_2.to_csv('/home/tsurendr/TABLES/AGE_60_70_SBL_Normalized.csv', index=False)
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_greater_70_SBL_Normalized_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_greater_70_SBL_Normalized_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/AGE_greater_70_SBL_Normalized_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_3.to_csv('/home/tsurendr/TABLES/AGE_greater_70_SBL_Normalized.csv', index=False)
