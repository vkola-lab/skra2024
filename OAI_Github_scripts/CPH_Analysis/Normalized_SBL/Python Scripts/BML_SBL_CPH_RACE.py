...
oai_right_temp_SBL_Femur_right = pd.concat( [oai_SBL_KL_BML_right.loc[:, 'F0_femur':'F199_femur'], oai_SBL_KL_BML_right[
    ['id',"time", "right_tkr", "P02SEX",'bml_total_femur','RACE','KL_Grade']]], axis = 1)

oai_right_temp_SBL_Tibia_right = pd.concat( [oai_SBL_KL_BML_right.loc[:, 'T0_tibia':'T199_tibia'], oai_SBL_KL_BML_right[
    ['id',"time", "right_tkr", "P02SEX",'bml_total_tibia','RACE','KL_Grade']]], axis = 1)


oai_right_temp_BML_Merged_right = oai_SBL_KL_BML_right[
    ['id',"time", "right_tkr", "P02SEX", "bml_total_merged",'RACE','KL_Grade']
]
oai_right_temp_BML_Femur_right = oai_SBL_KL_BML_right[
    ['id',"time", "right_tkr", "P02SEX", "bml_total_femur",'RACE','KL_Grade']
]
oai_right_temp_BML_Tibia_right = oai_SBL_KL_BML_right[
    ['id',"time", "right_tkr", "P02SEX", "bml_total_tibia",'RACE','KL_Grade']
]
...
#Splitting populations based on Race
other_merged = oai_right_temp_SBL_Merged_all.loc[oai_right_temp_SBL_Merged_all['RACE'] == '0: Other Non-white']
white_merged = oai_right_temp_SBL_Merged_all.loc[oai_right_temp_SBL_Merged_all['RACE'] == '1: White or Caucasian']
black_merged = oai_right_temp_SBL_Merged_all.loc[oai_right_temp_SBL_Merged_all['RACE'] == '2: Black or African American']
asian_merged = oai_right_temp_SBL_Merged_all.loc[oai_right_temp_SBL_Merged_all['RACE'] == '3: Asian']

other_femur = oai_right_temp_SBL_Femur_all.loc[oai_right_temp_SBL_Femur_all['RACE'] == '0: Other Non-white']
white_femur = oai_right_temp_SBL_Femur_all.loc[oai_right_temp_SBL_Femur_all['RACE'] == '1: White or Caucasian']
black_femur = oai_right_temp_SBL_Femur_all.loc[oai_right_temp_SBL_Femur_all['RACE'] == '2: Black or African American']
asian_femur = oai_right_temp_SBL_Femur_all.loc[oai_right_temp_SBL_Femur_all['RACE'] == '3: Asian']

other_tibia = oai_right_temp_SBL_Tibia_all.loc[oai_right_temp_SBL_Tibia_all['RACE'] == '0: Other Non-white']
white_tibia = oai_right_temp_SBL_Tibia_all.loc[oai_right_temp_SBL_Tibia_all['RACE'] == '1: White or Caucasian']
black_tibia = oai_right_temp_SBL_Tibia_all.loc[oai_right_temp_SBL_Tibia_all['RACE'] == '2: Black or African American']
asian_tibia = oai_right_temp_SBL_Tibia_all.loc[oai_right_temp_SBL_Tibia_all['RACE'] == '3: Asian']
...
# Selecting SBL, BML, Race, and TKR from each table before information is input into the CPH models


asian_sbl_merged =  pd.concat( [asian_merged.loc[:, 'F0_merged':'T199_merged'], asian_merged[
    ["time", "right_tkr"]]], axis = 1)
asian_sbl_femur =  pd.concat( [asian_femur.loc[:, 'F0_femur':'F199_femur'], asian_femur[
    ["time", "right_tkr"]]], axis = 1)
asian_sbl_tibia =  pd.concat( [asian_tibia.loc[:, 'T0_tibia':'T199_tibia'], asian_tibia[
    ["time", "right_tkr"]]], axis = 1)
asian_bml_merged = asian_merged[["time", "right_tkr", "bml_total_merged"]]
asian_bml_femur = asian_femur[["time", "right_tkr", "bml_total_femur"]]
asian_bml_tibia = asian_tibia[["time", "right_tkr", "bml_total_tibia"]]
asian_JSN_merged = asian_merged[["time", "right_tkr", "V00XRJSM",'V00XRJSL']]



white_sbl_merged =  pd.concat( [white_merged.loc[:, 'F0_merged':'T199_merged'], white_merged[
    ["time", "right_tkr"]]], axis = 1)
white_sbl_femur =  pd.concat( [white_femur.loc[:, 'F0_femur':'F199_femur'], white_femur[
    ["time", "right_tkr"]]], axis = 1)
white_sbl_tibia =  pd.concat( [white_tibia.loc[:, 'T0_tibia':'T199_tibia'], white_tibia[
    ["time", "right_tkr"]]], axis = 1)
white_bml_merged = white_merged[["time", "right_tkr", "bml_total_merged"]]
white_bml_femur = white_femur[["time", "right_tkr", "bml_total_femur"]]
white_bml_tibia = white_tibia[["time", "right_tkr", "bml_total_tibia"]]
white_JSN_merged = white_merged[["time", "right_tkr", "V00XRJSM",'V00XRJSL']]

black_sbl_merged =  pd.concat( [black_merged.loc[:, 'F0_merged':'T199_merged'], black_merged[
    ["time", "right_tkr"]]], axis = 1)
black_sbl_femur =  pd.concat( [black_femur.loc[:, 'F0_femur':'F199_femur'], black_femur[
    ["time", "right_tkr"]]], axis = 1)
black_sbl_tibia =  pd.concat( [black_tibia.loc[:, 'T0_tibia':'T199_tibia'], black_tibia[
    ["time", "right_tkr"]]], axis = 1)
black_bml_merged = black_merged[["time", "right_tkr", "bml_total_merged"]]
black_bml_femur = black_femur[["time", "right_tkr", "bml_total_femur"]]
black_bml_tibia = black_tibia[["time", "right_tkr", "bml_total_tibia"]]
black_JSN_merged = black_merged[["time", "right_tkr", "V00XRJSM",'V00XRJSL']]

other_sbl_merged =  pd.concat( [other_merged.loc[:, 'F0_merged':'T199_merged'], other_merged[
    ["time", "right_tkr"]]], axis = 1)
other_sbl_femur =  pd.concat( [other_femur.loc[:, 'F0_femur':'F199_femur'], other_femur[
    ["time", "right_tkr"]]], axis = 1)
other_sbl_tibia =  pd.concat( [other_tibia.loc[:, 'T0_tibia':'T199_tibia'], other_tibia[
    ["time", "right_tkr"]]], axis = 1)
other_bml_merged = other_merged[["time", "right_tkr", "bml_total_merged"]]
other_bml_femur = other_femur[["time", "right_tkr", "bml_total_femur"]]
other_bml_tibia = other_tibia[["time", "right_tkr", "bml_total_tibia"]]
other_JSN_merged = other_merged[["time", "right_tkr", "V00XRJSM",'V00XRJSL']]


# In[36]:


# Determining number of people in each race category
print('asian: ', len(asian_sbl_merged))
print('white: ', len(white_sbl_merged))
print('black: ', len(black_sbl_merged))
print('other: ', len(other_sbl_merged))
...
# CPH Model for SBL Merged data for patients Race Caucasian
cindex_1, brier_1, auc_1 = cph_creator_SBL(white_sbl_merged, True)


# In[38]:


# CPH Model for SBL Femur data for patients Race Caucasian
cindex_2, brier_2, auc_2 = cph_creator_SBL(white_sbl_femur, True)


# In[39]:


# CPH Model for SBL Tibia data for patients Race Caucasian
cindex_3, brier_3, auc_3 = cph_creator_SBL(white_sbl_tibia, True)


# In[40]:


# CPH Model for BML Merged data for patients Race Caucasian
cindex_4, brier_4, auc_4 = cph_creator_SBL(white_bml_merged, False)


# In[41]:


# CPH Model for BML Femur data for patients Race Caucasian
cindex_5, brier_5, auc_5 = cph_creator_SBL(white_bml_femur, False)


# In[42]:


# CPH Model for BML Tibia data for patients Race Caucasian
cindex_6, brier_6, auc_6 = cph_creator_SBL(white_bml_tibia, False)


# In[43]:


# CPH Model for JSN data for patients Race Caucasian
cindex_7, brier_7, auc_7 = cph_creator_SBL(white_JSN_merged, True)
...
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/RACE_CAUCASIAN_SBL_Normalized_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/RACE_CAUCASIAN_SBL_Normalized_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/RACE_CAUCASIAN_SBL_Normalized_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_1.to_csv('/home/tsurendr/TABLES/RACE_CAUCASIAN_SBL_Normalized.csv', index=False)


# In[45]:


# CPH Model for SBL Merged data for patients Race African American 
cindex_8, brier_8, auc_8 = cph_creator_SBL(black_sbl_merged, True)


# In[46]:


# CPH Model for SBL Femur data for patients Race African American 
cindex_9, brier_9, auc_9 = cph_creator_SBL(black_sbl_femur, True)


# In[47]:


# CPH Model for SBL Tibia data for patients Race African American 
cindex_10, brier_10, auc_10 = cph_creator_SBL(black_sbl_tibia, True)


# In[48]:


# CPH Model for BML Merged data for patients Race African American 
cindex_11, brier_11, auc_11 = cph_creator_SBL(black_bml_merged, False)


# In[49]:


# CPH Model for BML Femur data for patients Race African American 
cindex_12, brier_12, auc_12 = cph_creator_SBL(black_bml_femur, False)


# In[50]:


# CPH Model for BML Tibia data for patients Race African American 
cindex_13, brier_13, auc_13 = cph_creator_SBL(black_bml_tibia, False)


# In[51]:


# CPH Model for JSN data for patients Race African American 
cindex_14, brier_14, auc_14 = cph_creator_SBL(black_JSN_merged, True)
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/RACE_AFRICAN_SBL_Normalized_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/RACE_AFRICAN_SBL_Normalized_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Normalized_SBL/RACE_AFRICAN_SBL_Normalized_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_2.to_csv('/home/tsurendr/TABLES/RACE_AFRICAN_SBL_Normalized.csv', index=False)
