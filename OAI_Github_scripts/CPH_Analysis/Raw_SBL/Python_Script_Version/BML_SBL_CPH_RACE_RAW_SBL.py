...
asian_sbl_femur =  pd.concat( [asian_femur.loc[:, 'F0_merged':'F199_merged'], asian_femur[
    ["time", "right_tkr"]]], axis = 1)
asian_sbl_tibia =  pd.concat( [asian_tibia.loc[:, 'T0_merged':'T199_merged'], asian_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
white_sbl_merged =  pd.concat( [white_merged.loc[:, 'F0_merged':'T199_merged'], white_merged[
    ["time", "right_tkr"]]], axis = 1)
white_sbl_femur =  pd.concat( [white_femur.loc[:, 'F0_merged':'F199_merged'], white_femur[
    ["time", "right_tkr"]]], axis = 1)
white_sbl_tibia =  pd.concat( [white_tibia.loc[:, 'T0_merged':'T199_merged'], white_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
black_sbl_merged =  pd.concat( [black_merged.loc[:, 'F0_merged':'T199_merged'], black_merged[
    ["time", "right_tkr"]]], axis = 1)
black_sbl_femur =  pd.concat( [black_femur.loc[:, 'F0_merged':'F199_merged'], black_femur[
    ["time", "right_tkr"]]], axis = 1)
black_sbl_tibia =  pd.concat( [black_tibia.loc[:, 'T0_merged':'T199_merged'], black_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
other_sbl_merged =  pd.concat( [other_merged.loc[:, 'F0_merged':'T199_merged'], other_merged[
    ["time", "right_tkr"]]], axis = 1)
other_sbl_femur =  pd.concat( [other_femur.loc[:, 'F0_merged':'F199_merged'], other_femur[
    ["time", "right_tkr"]]], axis = 1)
other_sbl_tibia =  pd.concat( [other_tibia.loc[:, 'T0_merged':'T199_merged'], other_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/RACE_CAUCASIAN_SBL_RAW_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/RACE_CAUCASIAN_SBL_RAW_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/RACE_CAUCASIAN_SBL_RAW_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_1.to_csv('/home/tsurendr/TABLES/RACE_CAUCASIAN_SBL_RAW.csv', index=False)
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/RACE_AFRICAN_SBL_RAW_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/RACE_AFRICAN_SBL_RAW_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/RACE_AFRICAN_SBL_RAW_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_2.to_csv('/home/tsurendr/TABLES/RACE_AFRICAN_SBL_RAW.csv', index=False)
