...
name_list = df_normalized_SBL_both.columns.tolist()
# df_normalized_SBL_both['sbl_sum'] = df_normalized_SBL_both.sum(axis=1)
print(df_normalized_SBL_both)
...
df_normalized_SBL_both=(df_normalized_SBL_both-df_normalized_SBL_both.mean())/df_normalized_SBL_both.std()
df_normalized_SBL_both.columns = name_list
print(df_normalized_SBL_both)
...
#     ['id',"time", "right_tkr", "P02SEX",'KL_Grade','BMI', 'RACE','bml_total_merged','bml_total_femur','bml_total_tibia', "V00XRJSM",'V00XRJSL', 'sbl_sum']]
...
#     ['id',"time", "right_tkr", "P02SEX",'KL_Grade','BMI','bml_total_merged','bml_total_femur','bml_total_tibia', "V00XRJSM",'V00XRJSL', 'sbl_sum']]
...
less_25_sbl_femur =  pd.concat( [less_25_femur.loc[:, 'F0_merged':'F199_merged'], less_25_femur[
    ["time", "right_tkr"]]], axis = 1)
less_25_sbl_tibia =  pd.concat( [less_25_tibia.loc[:, 'T0_merged':'T199_merged'], less_25_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
mid_20_to_30_sbl_merged =  pd.concat( [mid_20_to_30_merged.loc[:, 'F0_merged':'T199_merged'], mid_20_to_30_merged[
    ["time", "right_tkr"]]], axis = 1)
mid_20_to_30_sbl_femur =  pd.concat( [mid_20_to_30_femur.loc[:, 'F0_merged':'F199_merged'], mid_20_to_30_femur[
    ["time", "right_tkr"]]], axis = 1)
mid_20_to_30_sbl_tibia =  pd.concat( [mid_20_to_30_tibia.loc[:, 'T0_merged':'T199_merged'], mid_20_to_30_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
more_30_sbl_merged =  pd.concat( [more_30_merged.loc[:, 'F0_merged':'T199_merged'], more_30_merged[
    ["time", "right_tkr"]]], axis = 1)
more_30_sbl_femur =  pd.concat( [more_30_femur.loc[:, 'F0_merged':'F199_merged'], more_30_femur[
    ["time", "right_tkr"]]], axis = 1)
more_30_sbl_tibia =  pd.concat( [more_30_tibia.loc[:, 'T0_merged':'T199_merged'], more_30_tibia[
    ["time", "right_tkr"]]], axis = 1)
...
# less_25_sbl_merged =  less_25_merged[
#     ["time", "right_tkr", 'sbl_sum']]
# less_25_sbl_femur =  pd.concat( [less_25_femur.loc[:, 'F0_merged':'F199_merged'], less_25_femur[
#     ["time", "right_tkr"]]], axis = 1)
# less_25_sbl_tibia =  pd.concat( [less_25_tibia.loc[:, 'T0_merged':'T199_merged'], less_25_tibia[
#     ["time", "right_tkr"]]], axis = 1)
...
# mid_20_to_30_sbl_merged =   mid_20_to_30_merged[
#     ["time", "right_tkr", 'sbl_sum']]
# mid_20_to_30_sbl_femur =  pd.concat( [mid_20_to_30_femur.loc[:, 'F0_merged':'F199_merged'], mid_20_to_30_femur[
#     ["time", "right_tkr"]]], axis = 1)
# mid_20_to_30_sbl_tibia =  pd.concat( [mid_20_to_30_tibia.loc[:, 'T0_merged':'T199_merged'], mid_20_to_30_tibia[
...
# more_30_sbl_merged =  more_30_merged[
#     ["time", "right_tkr", 'sbl_sum']]
# more_30_sbl_femur =  pd.concat( [more_30_femur.loc[:, 'F0_merged':'F199_merged'], more_30_femur[
#     ["time", "right_tkr"]]], axis = 1)
# more_30_sbl_tibia =  pd.concat( [more_30_tibia.loc[:, 'T0_merged':'T199_merged'], more_30_tibia[
...
print(len(less_25_sbl_merged[less_25_sbl_merged['right_tkr'] == 1]))
...
# cph.fit(less_25_sbl_merged, 'time', event_col="right_tkr", show_progress=True, robust=True)
# cph.print_summary()
# # cph.check_assumptions(oai_right_temp_SBL_Merged_all, show_plots=False, p_value_threshold=0.05)
...
# )
# merged_tkr_time = less_25_sbl_merged[["right_tkr", "time"]].copy()
...
# )
# males_merged_sbl = less_25_sbl_merged.copy().drop("time", axis=1)  # keep as a dataframe
# # print(males_merged_sbl)
# biomarker_vals = males_merged_sbl.copy().drop("right_tkr", axis=1)  # keep as a dataframe
# train, test = train_test_split(less_25_sbl_merged, test_size=0.2, random_state=120)
...
# # estimator = CoxnetSurvivalAnalysis().fit(biomarker_vals, merged_structured)
...
# # Sci-kit survival CPH model
# # estimator = CoxPHSurvivalAnalysis(alpha = 10).fit(biomarker_vals, merged_structured)
# estimator = CoxnetSurvivalAnalysis(fit_baseline_model = True).fit(biomarker_vals, merged_structured)
# survs = estimator.predict_survival_function(x_all_T)
# survs_predict = estimator.predict(x_all_T)
# times = np.arange(t_min, t_max)
# preds = np.asarray([[fn(t) for t in times] for fn in survs])
...
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_less_25_SBL_RAW_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_less_25_SBL_RAW_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_less_25_SBL_RAW_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_1.to_csv('/home/tsurendr/TABLES/BMI_less_25_SBL_RAW.csv', index=False)
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_25_30_SBL_RAW_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_25_30_SBL_RAW_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_25_30_SBL_RAW_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_2.to_csv('/home/tsurendr/TABLES/BMI_25_30_SBL_RAW.csv', index=False)
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_greater_30_SBL_RAW_CINDEX.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_greater_30_SBL_RAW_BRIER.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
plt.xticks(range(1, 7 + 1), labels, rotation=45, ha='right')
plt.show()
plt.savefig('/home/tsurendr/Error_bar_Plots/Raw_SBL/BMI_greater_30_SBL_RAW_AUC.pdf', format='pdf', bbox_inches = 'tight')
plt.clf()
...
table_df_3.to_csv('/home/tsurendr/TABLES/BMI_greater_30_SBL_RAW.csv', index=False)
